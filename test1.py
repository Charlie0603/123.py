...
for i in n2:
    ...
    if num == i:
        st.success("對中 20 萬元！") ＃顯示成功訊息
        st.image("恭喜中獎.jpg") 
        break
    elif num[-7:] == i[-7:]:
        st.success("對中 4 萬元！") ＃顯示成功訊息
        st.image("恭喜中獎.jpg")
        break
    elif num[-6:] == i[-6:]:
        st.success("對中 1 萬元！") ＃顯示成功訊息
        st.image("恭喜中獎.jpg")
        break
    elif num[-5:] == i[-5:]:
        st.success("對中 4000 元")  ＃顯示成功訊息
        st.image("恭喜中獎.jpg")
        break
    elif num[-4:] == i[-4:]:
        st.success("對中 1000 元！")  ＃顯示成功訊息
        st.image("恭喜中獎.jpg")
        break
    elif num[-3:] == i[-3:]:
        st.success("對中 200 元！")  ＃顯示成功訊息
        st.image("恭喜中獎.jpg")
        break
